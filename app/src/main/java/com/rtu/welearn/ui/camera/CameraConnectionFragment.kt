...
class CameraConnectionFragment @SuppressLint("ValidFragment") private constructor(
     ...
     *
     * @param viewonPreviewFrameWidth The width of `mTextureView`
    ...
    private var camCallback=android.hardware.Camera.PreviewCallback(){

        bytes: ByteArray?, camera: android.hardware.Camera? ->
        Log.d("Frame","")
    }
